...
E. Tugas
1. Integrasikan untuk create category supaya bisa menambahkan data category 
ke supabase
2. Integrasikan untuk list category yang terdapat pada Dropdown, yang awalnya 
list tersebut hanya data statis menjadi data yang sudah langsung mengambil 
ke supabase.
<template>
